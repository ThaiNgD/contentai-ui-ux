...
//  */
// const LICENSE_KEY: string = "GPL";

// if (LICENSE_KEY === "GPL") {
//   alert(
//     "Premium features are disabled, because they require a commercial license key. Check the index.js file for more information."
//   );
// }
