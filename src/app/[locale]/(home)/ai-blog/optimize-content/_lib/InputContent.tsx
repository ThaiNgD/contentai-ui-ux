...
import { useAiSeoOptimize } from "@/service/aiblog/useAiSeoOptimize";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate: aiSeoOptimize, isPending, data } = useAiSeoOptimize();
  const formik = useFormik<IFormSeoOptimize>({
    initialValues: {
      content: "",
      module: "",
      language: "",
