  ...
  return (
    <div className="2xl:px-[175px] px-[15px] py-[35px] h-[150px] flex items-center justify-between border-b">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-3xl font-extrabold">AI Plagiarism</h1>
        <span className="text-sm opacity-70">
          • Kiểm tra nội dung để phát hiện các đoạn văn bản có khả năng đạo văn
          từ các nguồn khác trên internet.
          <br /> • Đảm bảo tính nguyên bản và tránh các vấn đề về bản quyền
        </span>
      </div>
