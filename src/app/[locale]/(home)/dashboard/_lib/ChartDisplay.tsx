...
const ChartDisplay = () => {
  return (
    <div className="flex gap-2 mb-[60px]">
      <div className="w-[75%] flex px-10 py-8 dark:bg-black bg-white border flex-col rounded-lg shadow-lg gap-3">
        <div className="p-4">
      ...
      <div className="border shadow-lg bg-white dark:bg-black rounded-lg p-5">
        <PieChartComponent />
      </div>
    </div>
  );
