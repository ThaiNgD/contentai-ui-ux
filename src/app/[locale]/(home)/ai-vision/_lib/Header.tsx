  ...
  return (
    <div className="2xl:px-[175px] px-[15px] py-[35px] h-[150px] flex items-center justify-between border-b">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="md:text-3xl text-xl font-extrabold">AI Vision</h1>
        <span className="md:block hidden text-sm opacity-70">
          • Phân tích và xử lý hình ảnh.Trích xuất thông tin từ hình ảnh.
          <br /> • Nhận dạng đối tượng, cảnh vật, văn bản trong ảnh. Tạo mô tả
          hoặc chú thích cho hình ảnh.
        </span>
      </div>
