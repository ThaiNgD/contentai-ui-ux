...
import { useAiWebsiteFaq } from "@/service/aiwriter/content_website/useAiWebsiteFaq";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { data, mutate, isPending } = useAiWebsiteFaq();
  const formik = useFormik<IFormWebsiteFaq>({
    initialValues: {
      brandName: "",
      description: "",
      keywords: "",
