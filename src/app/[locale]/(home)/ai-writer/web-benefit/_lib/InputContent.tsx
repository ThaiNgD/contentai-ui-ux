...
import { useAiWebsiteBenefits } from "@/service/aiwriter/content_website/useAiWebsiteBenefit";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiWebsiteBenefits();
  const formik = useFormik<IFormWebsiteBenefits>({
    initialValues: {
      brandName: "",
      description: "",
      module: "",
