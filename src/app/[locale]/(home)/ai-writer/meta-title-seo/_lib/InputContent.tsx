...
import { useAiMetaTitle } from "@/service/aiwriter/seo_optimization/useAiMetaTitle";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiMetaTitle();
  const formik = useFormik<IFormMetaTitles>({
    initialValues: {
      brandName: "",
      keywords: "",
      module: "",
