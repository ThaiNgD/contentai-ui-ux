...
import { useAiStorytellingFormula } from "@/service/aiwriter/facebook-content/useAiStorytellingFormula";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiStorytellingFormula();
  const formik = useFormik<IFormStoryTellingPost>({
    initialValues: {
      brandName: "",
      productDescription: "",
      module: "",
