...
import { useAiTikTokVideoIdeas } from "@/service/aiwriter/ai-tiktok/useAiTikTokVideoIdeas";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiTikTokVideoIdeas();
  ...
  return (
    ...
    >
      ...
      <TextAreaField
        ...
        clsTitle="font-bold mb-1 italic"
        className="h-[125px] !bg-[#F5F9FC] shadow-inner min-h-[50px] max-x-[400px]"
        formik={formik}
      />
      <SelectField
