...
import { useAiLandingPageOutline } from "@/service/aiwriter/web-sale-content/useAiLandingPageOutline";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiLandingPageOutline();
  const formik = useFormik<IFormLandingPageOutLine>({
    initialValues: {
      brandName: "",
      keywords: "",
      module: "",
  ...
  return (
    ...
    >
      ...
      <InputField
        name={"keywords"}
        placeholder="Từ khóa mong muốn"
        title="Từ khóa mong muốn"
        clsTitle="font-bold mb-1 italic"
        className="h-[50px] !bg-[#F5F9FC] shadow-inner"
        formik={formik}
      />
