...
import { useAiHoneyComp } from "@/service/aiwriter/facebook-content/useAiHoneyComp";
...
const InputContent = ({ setCkData }: InputProps) => {
  ...
  const formik = useFormik<IFormHoneyCombPost>({
    initialValues: {
      brandName: "",
      productDescription: "",
      module: "",
  ...
  return (
    ...
    >
      ...
      <TextAreaField
        ...
        clsTitle="font-bold mb-1 italic"
        className="h-[100px] min-h-[50px] max-h-[400px] !bg-[#F5F9FC] shadow-inner"
        formik={formik}
      />
      <SelectField
