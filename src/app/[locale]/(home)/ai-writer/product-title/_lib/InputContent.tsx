...
import { useAiProductTitle } from "@/service/aiwriter/web-sale-content/useAiProductTitle";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiProductTitle();
  const formik = useFormik<IFormProductTitle>({
    initialValues: {
      brandName: "",
      productKeywords: "",
      module: "",
