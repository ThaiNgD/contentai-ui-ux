...
import { useAiLivestreamScript } from "@/service/aiwriter/video-script/useAiLivestreamScript";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiLivestreamScript();
  const formik = useFormik<IFormLiveStreamScript>({
    initialValues: {
      brandName: "",
      productDescription: "",
      module: "",
