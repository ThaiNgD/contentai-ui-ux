...
import { useAiBlogConclusion } from "@/service/aiwriter/aiblog_v2/useAiBlogConclusion";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { data, isPending, mutate } = useAiBlogConclusion();
  const formik = useFormik<IFormBlogConclusion>({
    initialValues: {
      brandName: "",
      keyword: "",
      module: "",
