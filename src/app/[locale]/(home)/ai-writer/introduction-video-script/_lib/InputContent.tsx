...
import { useAiIntroductrionScript } from "@/service/aiwriter/video-script/useAiIntroductionScript";
...
const InputContent = ({ setCkData }: InputProps) => {
  const { mutate, isPending, data } = useAiIntroductrionScript();
  const formik = useFormik<IFormIntroductionVideoScript>({
    initialValues: {
      brandName: "",
      productDescription: "",
      module: "",
